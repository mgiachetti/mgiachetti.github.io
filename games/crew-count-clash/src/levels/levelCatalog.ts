...
export const levelCatalog: LevelData[] = [
  ...
  },
  {
    ...
    entities: [
      ...
      { id: "l4-jump-a", kind: "jumpPad", x: -2.2, z: 40 },
  ...
  },
  {
    ...
    entities: [
      ...
      { id: "l9-jump-a", kind: "jumpPad", x: 0, z: 52 },
  ...
  },
  {
    ...
    entities: [
      ...
      { id: "l14-jump-a", kind: "jumpPad", x: -1.9, z: 66 },
      { id: "l14-hole-a", kind: "hole", x: -1.9, z: 72, width: 1.9, depth: 3.3 },
      { id: "l14-jump-b", kind: "jumpPad", x: 1.9, z: 82 },
  ...
  },
  {
    ...
    entities: [
      ...
      { id: "l19-jump-a", kind: "jumpPad", x: 0, z: 62 },
